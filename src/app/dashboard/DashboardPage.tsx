...
function AuthPage({ onLogin }: { onLogin: (jwt: string, email: string) => void }) {
  ...
  function reset(t: "login" | "register" | "forgot") {
    setTab(t); setError(null); setNotice(null);
  }
            ...
            <div className="rounded-2xl border border-white/10 bg-[#141414] p-10 flex flex-col items-center gap-5">
              ...
              <div>
                ...
                <p className="text-sm text-paper/50 leading-relaxed">
                  We sent a confirmation link to <span className="text-paper/80 font-medium">{email}</span>.
              ...
              <p className="text-xs text-paper/30 border border-white/8 rounded-lg px-4 py-3 bg-white/3 w-full text-left leading-relaxed">
                <span className="text-paper/50 font-medium">Note:</span> You won't be able to log in until you click the link in the email.
              </p>
              <button
                onClick={() => { setRegistered(false); reset("login"); }}
        ...
        <div className="w-full max-w-[400px]">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-2xl font-bold tracking-tight">
              {isForgot ? "Reset your password" : tab === "login" ? "Sign in" : "Create an account"}
            </h1>
              ...
              {!isForgot && (
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <label className="text-xs text-paper/40 font-medium tracking-wide">Password</label>
                    {tab === "login" && (
                      <button
                        type="button"
...
const REFS: { id: number; authors: string; title: string; venue: string; year: number; href: string }[] = [
  { id: 1,  authors: "Dreczkowski K., Vitiello P., Vosylius V. et al.", title: "Learning a Thousand Tasks in a Day", venue: "7th Robot Learning Workshop, NeurIPS", year: 2024, href: "https://arxiv.org/abs/2511.10110" },
  { id: 2,  authors: "Florence P.R., Manuelli L., Tedrake R.", title: "Dense Object Nets: Learning Dense Visual Object Descriptors by and for Robotic Manipulation", venue: "CoRL", year: 2018, href: "https://arxiv.org/abs/1806.08756" },
  { id: 3,  authors: "Simeonov A., Du Y., Tagliasacchi A. et al.", title: "Neural Descriptor Fields: SE(3)-Equivariant Object Representations for Manipulation", venue: "ICRA", year: 2022, href: "https://arxiv.org/abs/2112.05124" },
  { id: 4,  authors: "Zhang J., Herrmann C., Hur J. et al.", title: "A Tale of Two Features: Stable Diffusion Complements DINO for Zero-Shot Semantic Correspondence", venue: "NeurIPS", year: 2023, href: "https://arxiv.org/abs/2305.15347" },
  { id: 5,  authors: "Zhou C., Zhu C., Xiong Y. et al.", title: "EdgeTAM: On-Device Track Anything Model", venue: "CVPR", year: 2025, href: "https://arxiv.org/abs/2501.07256" },
  { id: 6,  authors: "Wen B., Trepte M., Aribido J. et al.", title: "FoundationStereo: Zero-Shot Stereo Matching", venue: "CVPR", year: 2025, href: "https://arxiv.org/abs/2501.09898" },
  { id: 7,  authors: "Vitiello P., Dreczkowski K., Johns E.", title: "One-Shot Imitation Learning: A Pose Estimation Perspective", venue: "arXiv", year: 2023, href: "https://arxiv.org/abs/2310.12077" },
  { id: 8,  authors: "Wang Y., Johns E.", title: "One-Shot Dual-Arm Imitation Learning", venue: "arXiv", year: 2025, href: "https://arxiv.org/abs/2503.06831" },
  { id: 9,  authors: "Di Palo N., Johns E.", title: "DINOBot: Robot Manipulation via Retrieval and Alignment with Vision Foundation Models", venue: "ICRA", year: 2024, href: "https://arxiv.org/abs/2402.13181" },
  { id: 10, authors: "Heppert N., Argus M., Welschehold T. et al.", title: "DITTO: Demonstration Imitation by Trajectory Transformation", venue: "IROS", year: 2024, href: "https://arxiv.org/abs/2403.15203" },
  { id: 11, authors: "Rusu R.B., Blodow N., Beetz M.", title: "Fast Point Feature Histograms (FPFH) for 3D Registration", venue: "ICRA", year: 2009, href: "https://open3d.org/docs/latest/tutorial/pipelines/global_registration.html" },
  { id: 12, authors: "Segal A., Haehnel D., Thrun S.", title: "Generalized-ICP", venue: "Robotics: Science and Systems", year: 2009, href: "https://www.roboticsproceedings.org/rss05/p21.pdf" },
];
      ...
      {ids.map((id, i) => (
        <span key={id}>
          ...
          <a
            ...
            onClick={(e) => { e.preventDefault(); document.getElementById(`ref-${id}`)?.scrollIntoView({ behavior: "smooth", block: "center" }); }}
          >
            [{id}]
          </a>
        </span>
    ...
    <div className="flex gap-8">
      ...
      <aside className="w-44 shrink-0 hidden md:block">
        <div className="sticky top-0 flex flex-col gap-0.5 pt-1">
          <p className="text-xs uppercase tracking-widest text-paper/25 font-medium px-2 mb-2">On this page</p>
          {TECH_SECTIONS.map((s) => (
            <button
              key={s.id}
              onClick={() => scrollTo(s.id)}
              className={`text-left px-2 py-1.5 rounded text-sm transition cursor-pointer ${
                activeSection === s.id ? "text-paper font-medium" : "text-paper/35 hover:text-paper/70"
              }`}
            >
              {s.label}
            </button>
      ...
      <div className="flex-1 flex flex-col gap-14 min-w-0">
        ...
        <div className="rounded-xl border border-white/8 overflow-hidden">
          <div className="px-5 py-4 border-b border-white/8 bg-white/2 flex items-center justify-between">
            <p className="text-xs text-paper/30 font-medium uppercase tracking-widest">Watch it in action</p>
            <a
        ...
        <section id="tech-problem" className="flex flex-col gap-5">
          <div>
            <p className="text-xs uppercase tracking-widest text-[var(--violet)] font-medium mb-3">Technical overview</p>
            <h2 className="text-2xl font-bold tracking-tight">Towards an adaptive robotic manipulator</h2>
          </div>

          <p className="text-sm text-paper/55 leading-relaxed">
            We consider a robotic arm equipped with exteroceptive sensors — a calibrated stereo camera pair —
            that must be capable of manipulating objects of arbitrary shape in uncontrolled environments.
            The system is designed to handle domestic, industrial, and exhibition settings without
            environment-specific retraining.
          </p>

          <p className="text-sm text-paper/55 leading-relaxed">
            Manipulation of this nature is a complex task conditioned on physical characteristics
            (mass, centre of gravity, geometry, material, graspable surface) that vary across objects.
            A viable system must generalise across object instances, poses, and scene compositions,
            while remaining economical in demonstration effort.
          </p>

          <p className="text-sm text-paper/55 leading-relaxed">
            Formally, we seek a policy <em>π</em> that, given a single expert demonstration of a task
            on object <em>o</em> at pose <em>p</em><sub>demo</sub>, can reproduce the task on any
            semantically similar object at an arbitrary pose <em>p</em><sub>inf</sub> — without
        ...
        <section id="tech-motivation" className="flex flex-col gap-5">
          ...
          <p className="text-sm text-paper/55 leading-relaxed">
            Three families of methods currently dominate robotic manipulation. We evaluated each against
            our constraints of data scarcity, deployment flexibility, and out-of-distribution generalisation.
          </p>
            ...
            {[
              {
                ...
                body: (
                  <p className="text-sm text-paper/45 leading-relaxed">
                    IL methods such as Diffusion Policy require 300–8,000 demonstrations per
                    task to obtain a stable, generalisable policy. Generalisation
                    is strictly local to the training distribution; changes in robot pose, object
                    appearance, or environment structure lead to policy collapse. The data
                    collection burden and the absence of cross-distribution generalisation make
                    IL impractical for our deployment constraints.
                  </p>
                ),
              },
              {
              ...
              },
              {
                ...
                body: (
                  <p className="text-sm text-paper/45 leading-relaxed">
                    Sim-to-real RL can produce robust and high-performance controllers for
                    fixed tasks. However, training a separate policy per object is computationally
                    intractable given the open-ended object space we target. An end-to-end
                    approach (RGBD → action) would require capturing data for every distinct
                    object, and tasks requiring long sequential memory (e.g. surface cleaning)
                    further complicate reward design.
                  </p>
                ),
              },
            ].map((a) => (
              <div key={a.name} className="rounded-xl border border-white/8 overflow-hidden">
                <div className="flex items-center justify-between gap-3 px-5 py-3 border-b border-white/8 bg-white/2">
                  ...
                  <span className={`text-xs font-medium px-2 py-0.5 rounded border ${a.color}`}>{a.verdict}</span>
                </div>
        ...
        <section id="tech-approach" className="flex flex-col gap-5">
          ...
          <p className="text-sm text-paper/55 leading-relaxed">
            We propose a <strong className="text-paper/80">one-shot imitation learning system</strong> that
            decouples perception from action by reformulating manipulation as a{" "}
            <em>gripper–robot–object alignment problem</em>. The approach is directly inspired by work at
            the Robot Learning Lab, Imperial College London
            <Ref ids={[7, 8, 9]} /> and extended with recent advances in dense visual
            descriptors.<Ref ids={[2, 3, 4]} />
          </p>

          <p className="text-sm text-paper/55 leading-relaxed">
            The core insight, formalised in <em>MT3</em> (Multi-Task Trajectory Transfer)<Ref ids={[1]} />,
            is that manipulation can be decomposed into two independent phases:
          </p>

          <div className="grid sm:grid-cols-2 gap-3">
            <div className="rounded-xl border border-white/8 p-5 flex flex-col gap-2">
              <span className="text-xs font-mono text-[var(--violet)] font-semibold">Phase 1 — Alignment</span>
              <p className="text-sm text-paper/45 leading-relaxed">
            ...
            <div className="rounded-xl border border-white/8 p-5 flex flex-col gap-2">
              <span className="text-xs font-mono text-[var(--violet)] font-semibold">Phase 2 — Interaction</span>
              <p className="text-sm text-paper/45 leading-relaxed">
                Apply the estimated pose delta to the stored demonstration trajectory, then
                execute the adapted waypoints using an inverse kinematics solver.
              </p>
            </div>
          </div>
          ...
          <p className="text-sm text-paper/55 leading-relaxed">
            ...
            <strong className="text-paper/80">order-of-magnitude improvement in data efficiency</strong>:
            a single demonstration is sufficient to generate a repeatable, robust expert trajectory.
            The method requires only an embedded GPU or DNN accelerator for the perception stack
            and a standard CPU for trajectory execution — making it significantly more cost-effective
            and deployable than VLA or end-to-end IL approaches.
          </p>
          ...
          <p className="text-sm text-paper/55 leading-relaxed">
            ...
            <strong className="text-paper/80">dense descriptor matching</strong><Ref ids={[2, 3, 4]} /> —
            a visual encoder that assigns a feature vector to every image pixel, enabling robust
            correspondence estimation between the demo template and a new object instance without
            retraining or text prompting.
          </p>
        </section>
        ...
        <section id="tech-demo" className="flex flex-col gap-6">
          <div>
            ...
            <p className="text-sm text-paper/45 mt-1 leading-relaxed">
              The goal of the demo phase is to build a 3D representation of the scene and the target object,
              then anchor the recorded robot trajectory to that representation. This is executed once per skill.
            </p>
          </div>
            ...
            {[
                ...
                content: (
                  <>
                    <p className="text-sm text-paper/45 leading-relaxed">
                      ...
                      network<Ref ids={[6]} /> to produce a dense disparity map <em>D</em> ∈ ℝ<sup>H×W</sup>.
                      Metric depth is recovered from disparity using the known stereo baseline <em>b</em>
              ...
              },
              {
                ...
                content: (
                  <>
                    <p className="text-sm text-paper/45 leading-relaxed">
                      The user-defined bounding box is passed to <strong className="text-paper/70">EdgeTAM</strong>
                      <Ref ids={[5]} />, an on-device variant of the Segment Anything Model optimised for
                      edge deployment. It produces a pixel-accurate binary mask <em>M</em> ∈ {"{0,1}"}
                      <sup>H×W</sup> of the target object. This mask isolates the object's depth values
                      from the full disparity map, yielding a masked disparity map <em>D̃ = D ⊙ M</em>.
                    </p>
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    <p className="text-sm text-paper/45 leading-relaxed">
                      Two pointclouds are reconstructed by back-projecting pixel coordinates and their
                      associated depth values into 3D using the camera intrinsic matrix <em>K</em> and
                      the extrinsic transform <em>T</em><sub>cam→base</sub> from the stereo calibration:
                    </p>
                    <div className="rounded-lg bg-[#0d0d0d] border border-white/8 px-4 py-3 font-mono text-sm text-paper/60 my-1">
                      P = T<sub>cam→base</sub> · K<sup>-1</sup> · [u · Z, v · Z, Z, 1]<sup>T</sup>
                    </div>
                    <p className="text-sm text-paper/40 leading-relaxed">
                      The <strong className="text-paper/65">full scene pointcloud</strong> <em>𝒫</em><sub>scene</sub> uses
                      the complete disparity map; the <strong className="text-paper/65">object pointcloud</strong>{" "}
                      <em>𝒫</em><sub>obj</sub> uses only the masked region. Both are expressed in the
                      robot base frame.
                    </p>
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    <p className="text-sm text-paper/45 leading-relaxed">
                      During kinesthetic or teleoperated demonstration, the 6-DoF gripper trajectory is
                      recorded as a sequence of homogeneous transforms{" "}
                      <em>{"{"}</em>W<sub>i</sub> ∈ SE(3)<em>{"}"}</em> expressed in the robot base frame
                      (recovered via forward kinematics and joint proprioception).
                      The trajectory is stored alongside <em>𝒫</em><sub>obj</sub> and the template
                      image <em>I</em><sub>demo</sub>. Each atomic interaction should constitute
                      a separate demonstration — composite tasks decompose into a sequence of
                      independently learned skills.
                    </p>
                  </>
                ),
              },
              ...
              <div key={s.step} className="rounded-xl border border-white/8 overflow-hidden">
                <div className="flex items-center gap-3 px-5 py-3 border-b border-white/8 bg-white/2">
                  <span className="text-xs font-mono text-[var(--violet)] font-semibold w-4">{s.step}</span>
          ...
          <div className="rounded-xl border border-white/8 overflow-hidden">
            <div className="px-4 py-2.5 border-b border-white/8 bg-white/2">
              <p className="text-xs text-paper/30 font-medium uppercase tracking-widest">Figure 1 — Demo phase pipeline</p>
            </div>
            <div className="p-4 bg-white/[0.02]">
              <img src="/pipeline-demo.png" alt="Demo phase pipeline" className="w-full rounded-lg" />
            </div>
          </div>
        </section>
        ...
        <section id="tech-inference" className="flex flex-col gap-6">
          <div>
            ...
            <p className="text-sm text-paper/45 mt-1 leading-relaxed">
              At inference time, the system estimates the relative 6-DoF pose <em>T</em><sub>Δ</sub> between
              the demo object pose and its current pose, then applies this transform to the stored trajectory.
              No retraining or additional demonstrations are required.
            </p>
          </div>
            ...
            {[
              {
                ...
                content: (
                  <p className="text-sm text-paper/45 leading-relaxed">
                    ...
                    pair, yielding an inference disparity map <em>D</em><sub>inf</sub> and the
                    corresponding scene pointcloud <em>𝒫</em><sub>inf,scene</sub>.
                  </p>
                ),
              },
              {
                ...
                content: (
                  <>
                    <p className="text-sm text-paper/45 leading-relaxed">
                      Rather than relying on sparse keypoint detectors (e.g. SIFT/ORB), which degrade
                      on textureless or reflective surfaces, the system employs{" "}
                      <strong className="text-paper/70">dense visual descriptors</strong><Ref ids={[2, 3, 4]} />:
                      a deep encoder assigns a feature vector <em>φ(u,v)</em> ∈ ℝ<sup>d</sup> to
                      every pixel of both the demo template <em>I</em><sub>demo</sub> and the new
                      inference frame <em>I</em><sub>inf</sub>.
                    </p>
                    <p className="text-sm text-paper/45 leading-relaxed">
                      The matcher finds the bounding box in <em>I</em><sub>inf</sub> whose descriptor
                      distribution best aligns with the object region in <em>I</em><sub>demo</sub>,
                      without any text prompt or task-specific fine-tuning. This is an extension of the
                      retrieval-based alignment approach introduced in MT3<Ref ids={[1]} /> and further
                      developed in DINOBot<Ref ids={[9]} />.
                    </p>
                    <div className="flex flex-wrap gap-6 text-xs text-paper/35 mt-1 font-mono">
                      <span>Input → I<sub>demo</sub>, I<sub>inf</sub></span>
                      <span className="text-paper/20">·</span>
                      <span>Output → bounding box [x1,y1,x2,y2]<sub>inf</sub></span>
                    </div>
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    <p className="text-sm text-paper/45 leading-relaxed">
                      EdgeTAM<Ref ids={[5]} /> segments the detected bounding box in <em>I</em><sub>inf</sub>,
                      producing mask <em>M</em><sub>inf</sub>. Applied to <em>D</em><sub>inf</sub> and
                      back-projected using the calibration, this yields the inference object pointcloud{" "}
                      <em>𝒫</em><sub>inf,obj</sub> — the 3D shape of the object at its current position
              ...
              },
              {
                ...
                content: (
                  <>
                    <p className="text-sm text-paper/45 leading-relaxed">
                      <strong className="text-paper/70">Fast Point Feature Histograms (FPFH)</strong>
                      <Ref ids={[11]} /> compute a 33-dimensional local geometry descriptor at each
                      point in <em>𝒫</em><sub>obj</sub> and <em>𝒫</em><sub>inf,obj</sub>, encoding
                      the angular relationships between point normals in the neighbourhood.
                      RANSAC samples sets of FPFH correspondences and estimates the coarse rigid
                      transform <em>T</em><sub>coarse</sub> ∈ SE(3) by rejecting outlier matches.
                    </p>
                    <div className="flex flex-wrap gap-6 text-xs text-paper/35 mt-1 font-mono">
                      <span>Input → 𝒫<sub>obj</sub>, 𝒫<sub>inf,obj</sub></span>
                      <span className="text-paper/20">·</span>
                      <span>Output → T<sub>coarse</sub> ∈ SE(3)</span>
                    </div>
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    <p className="text-sm text-paper/45 leading-relaxed">
                      <strong className="text-paper/70">Generalised ICP (G-ICP)</strong><Ref ids={[12]} />
                      takes <em>T</em><sub>coarse</sub> as initialisation and minimises a
                      point-to-plane objective that models local surface covariance at each point.
                      This yields the refined pose delta <em>T</em><sub>Δ</sub> ∈ SE(3), representing
                      the full 6-DoF transform from the demo object frame to the current object frame.
                    </p>
                    <div className="flex flex-wrap gap-6 text-xs text-paper/35 mt-1 font-mono">
                      <span>Input → T<sub>coarse</sub>, 𝒫<sub>obj</sub>, 𝒫<sub>inf,obj</sub></span>
                      <span className="text-paper/20">·</span>
                      <span>Output → T<sub>Δ</sub> ∈ SE(3)</span>
                    </div>
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    <p className="text-sm text-paper/45 leading-relaxed">
                      Each waypoint W<sub>i</sub> ∈ SE(3) in the stored trajectory is transformed
                      by left-multiplying with the pose delta:
                    </p>
                    <div className="rounded-lg bg-[#0d0d0d] border border-white/8 px-4 py-3 font-mono text-sm text-paper/60 my-1">
                      W′<sub>i</sub> = T<sub>Δ</sub> · W<sub>i</sub>, &nbsp; ∀i ∈ [1, N]
                    </div>
                    <p className="text-sm text-paper/40 leading-relaxed">
                      The adapted sequence {"{"}<em>W′<sub>i</sub></em>{"}"} is returned as the action plan.
                      Trajectory execution uses an inverse kinematics solver in Cartesian
                      space. The current implementation operates open-loop — sensor feedback
                      during execution is a planned extension (see Future directions).
                      If alignment fails or the object is not detected, the plan is empty.
                    </p>
                  </>
                ),
              },
          ...
          <div className="rounded-xl border border-white/8 overflow-hidden">
            <div className="px-4 py-2.5 border-b border-white/8 bg-white/2">
              <p className="text-xs text-paper/30 font-medium uppercase tracking-widest">Figure 2 — Inference phase pipeline</p>
            </div>
            <div className="p-4 bg-white/[0.02]">
              <img src="/pipeline-inference.png" alt="Inference phase pipeline" className="w-full rounded-lg" />
            </div>
          </div>
        </section>
        ...
        <section id="tech-future" className="flex flex-col gap-5">
          ...
          <p className="text-sm text-paper/55 leading-relaxed">
            The current system is sufficient for repetitive manipulation tasks in structured environments.
            Several extensions are planned to improve generalisation and robustness.
          </p>
          <div className="flex flex-col gap-3">
            {[
              {
              ...
              <div key={f.title} className="rounded-xl border border-white/8 p-5 flex flex-col gap-2">
        ...
        <section id="tech-references" className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            {REFS.map((r) => (
              <div key={r.id} id={`ref-${r.id}`} className="flex gap-4 text-sm text-paper/45 leading-relaxed scroll-mt-4 rounded-lg px-3 py-2 hover:bg-white/3 transition">
                <span className="font-mono text-paper/25 shrink-0 w-6 text-right">[{r.id}]</span>
                <span>
                  {r.authors}{" "}
                  <a href={r.href} target="_blank" rel="noopener noreferrer" className="italic text-paper/65 hover:text-[var(--violet)] transition">
                    {r.title}
                  </a>
                  {". "}
                  <span className="text-paper/30">{r.venue}, {r.year}.</span>
                </span>
              </div>
            ))}
          </div>
...
const ENDPOINTS: {
  ...
  },
  {
    ...
    description: "Closes a session and frees its server resources. Called automatically when using the SDK context manager.",
    returns: "{ info: string }",
  },
  {
    method: "POST",
...
function CodeBlock({ code }: { code: string }) {
  ...
  return (
    <div className="relative group rounded-lg bg-[#0d0d0d] border border-white/8 overflow-hidden">
      <pre className="text-xs font-mono text-paper/60 p-4 overflow-x-auto leading-relaxed">{code}</pre>
      <button
        onClick={copy}
      ...
      <div className="flex-1 flex flex-col gap-14 min-w-0">
        ...
        <section id="doc-quickstart" className="flex flex-col gap-5">
          <div>
            ...
            <p className="text-sm text-paper/45 mt-1">Install the SDK and run your first skill in minutes.</p>
          </div>
          <div className="flex flex-col gap-3">
        ...
        <section id="doc-auth" className="flex flex-col gap-5">
          <div>
            ...
            <p className="text-sm text-paper/45 mt-1">
              ...
              <button onClick={() => {}} className="text-[var(--violet)] hover:underline cursor-pointer">API Keys</button> tab.
            </p>
          </div>
          <div className="rounded-xl border border-white/8 divide-y divide-white/8">
            <div className="px-5 py-4 flex flex-col gap-1">
              <p className="text-xs text-paper/30 uppercase tracking-widest font-medium">HTTP header</p>
              <CodeBlock code={`Authorization: Bearer lilio_sk_...`} />
            </div>
            <div className="px-5 py-4 flex flex-col gap-1">
              <p className="text-xs text-paper/30 uppercase tracking-widest font-medium">Python SDK</p>
              <CodeBlock code={`from lilio import LilioClient\n\nclient = LilioClient(api_key="lilio_sk_...")`} />
            </div>
          </div>
        </section>
        ...
        <section id="doc-sessions" className="flex flex-col gap-5">
          <div>
            ...
            <p className="text-sm text-paper/45 mt-1">
              Every robot run requires an open session. A session holds the depth model initialised with your camera
              calibration and the intermediate demo state. Skills are persisted to your account and survive beyond
              the session.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              { label: "Open", code: "POST /session", note: "Pass camera_calibration from your config JSON." },
              { label: "Close", code: "DELETE /session/{id}", note: "Always close when the run is finished. SDK handles this automatically." },
            ].map((r) => (
              <div key={r.label} className="rounded-xl border border-white/8 p-5 flex flex-col gap-2">
                <p className="text-xs text-paper/30 uppercase tracking-widest font-medium">{r.label}</p>
                <code className="text-sm font-mono text-paper/75">{r.code}</code>
                <p className="text-xs text-paper/40">{r.note}</p>
              </div>
            ))}
          </div>
          <CodeBlock code={`with client.session(camera_calibration) as session:\n    ...  # session closes automatically, even on error`} />
        </section>
        ...
        <section id="doc-demo-guide" className="flex flex-col gap-6">
          <div>
            ...
            <p className="text-sm text-paper/45 mt-1 leading-relaxed">
              A skill is recorded in three sequential steps: capture the ROI, align the robot, then record
              the trajectory. The order matters — and the object must not move between any of these steps.
            </p>
          </div>

          {/* critical warning */}
          <div className="rounded-xl border border-amber-500/25 bg-amber-500/5 px-5 py-4 flex gap-3">
            <svg className="shrink-0 mt-0.5 text-amber-400" width="15" height="15" viewBox="0 0 15 15" fill="none">
            ...
            <div className="flex flex-col gap-1">
              <p className="text-sm font-semibold text-amber-400">Do not move the object between steps</p>
              <p className="text-sm text-amber-400/70 leading-relaxed">
                The system anchors the trajectory to the object's visual features at its exact 3D Cartesian
                position in the robot frame. Moving the object after capturing the ROI will corrupt the
                geometric anchor and produce incorrect trajectories at inference time.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <div key={s.step} className="rounded-xl border border-white/8 overflow-hidden">
                <div className="flex items-center gap-3 px-5 py-3 border-b border-white/8 bg-white/2">
                  <span className="text-xs font-mono text-[var(--violet)] font-semibold w-4 shrink-0">{s.step}</span>
          ...
          <div className="rounded-xl border border-white/8 px-5 py-4 flex gap-3 items-start">
            <svg className="shrink-0 mt-0.5 text-paper/30" width="14" height="14" viewBox="0 0 15 15" fill="none">
            ...
            <p className="text-sm text-paper/40 leading-relaxed">
              Each atomic interaction should be its own skill. Composite tasks — e.g. picking an object
              then placing it — should be recorded as two separate skills and executed sequentially.
            </p>
          </div>
        </section>
          ...
          {ENDPOINTS.map((ep) => (
            <div key={ep.path} className="rounded-xl border border-white/8 overflow-hidden">
              ...
              <div className="flex items-center gap-3 px-5 py-3.5 border-b border-white/8 bg-white/2">
                <span className={`text-xs font-mono font-semibold px-2 py-0.5 rounded border shrink-0 ${METHOD_COLOR[ep.method]}`}>
                  {ep.method}
                </span>
              ...
              <div className="px-5 py-5 flex flex-col gap-5">
                ...
                {ep.body && (
                  <div>
                    <p className="text-xs uppercase tracking-widest text-paper/25 font-medium mb-3">Request body</p>
                    <div className="rounded-lg border border-white/8 divide-y divide-white/5 overflow-hidden">
                      {ep.body.map((f) => (
                        <div key={f.field} className="grid grid-cols-[140px_100px_1fr] gap-3 px-4 py-3 text-sm items-start">
                ...
                {ep.sdkExample && (
                  <div>
                    <p className="text-xs uppercase tracking-widest text-paper/25 font-medium mb-2">SDK example</p>
    ...
    <div className="theme-dark bg-ink text-paper min-h-screen flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto">
          <div className={`mx-auto px-8 py-10 ${tab === "docs" || tab === "tech" ? "max-w-5xl" : "max-w-3xl"}`}>
            {tab === "tech" && <TechTab />}
            {tab === "docs" && <DocsTab />}
