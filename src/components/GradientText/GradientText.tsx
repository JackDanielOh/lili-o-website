...
export default function GradientText({
  ...
  const Wrapper = showBorder ? motion.div : motion.span;
  const inlineClass = showBorder ? "" : "inline";

  return (
    <Wrapper
      className={`animated-gradient-text ${inlineClass} ${showBorder ? "with-border" : ""} ${className}`}
